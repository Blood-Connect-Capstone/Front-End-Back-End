    ...
    <nav>
      <div class="nav nav-tabs" role="tablist">
        <template v-for="tab in tabs" :key="tab.id">
          <button class="nav-link" :class="{ active: activeTab === tab.id }" type="button" @click="onTabClick(tab.id)">
            <img :src="tab.icon" class="tab-img" :class="{ active: activeTab === tab.id }" alt="" width="18" height="18" />
            {{ tab.label }}
          </button>
          <div v-if="activeTab === tab.id" class="tab-pane-mobile">
